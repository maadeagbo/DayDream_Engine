...
./bin/shader_reflect -o include/ddShaderReflect.h -e RE_Light \
...
./bin/shader_reflect -o include/ddShaderReflect.h -a -e RE_Shadow \
	-v "$SDIR/Resource/Shaders/Depth_V.vert" \
	-f "$SDIR/Resource/Shaders/Depth_F.frag"

# reflect skinned shadow shader
./bin/shader_reflect -o include/ddShaderReflect.h -a -e RE_ShadowSk \

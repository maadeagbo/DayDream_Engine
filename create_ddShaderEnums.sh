...
./bin/dd_shader_reflect -o includes/ddShaderReflect.h -a -e RE_Shadow \
	-v "$SDIR/Resource/Shaders/Depth_V.vert" \
	-f "$SDIR/Resource/Shaders/Depth_F.frag"

# reflect skinned shadow shader
./bin/dd_shader_reflect -o includes/ddShaderReflect.h -a -e RE_ShadowSk \

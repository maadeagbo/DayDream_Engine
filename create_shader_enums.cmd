...
%cd%\bin\shader_reflect.exe -o includes\ddShaderReflect.h -a -e RE_Shadow^
	-v "%SDIR%\Resource\Shaders\Depth_V.vert" ^
	-f "%SDIR%\Resource\Shaders\Depth_F.frag"

:: reflect skinned shadow shader
%cd%\bin\shader_reflect.exe -o includes\ddShaderReflect.h -a -e RE_ShadowSk^
